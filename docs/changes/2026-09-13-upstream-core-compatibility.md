...
Release 0.3.3-rc2.3 accepts Core 0.3.12-rc2.1 in the explicit peer ranges, preserving the previously accepted RC2 versions. The build uses the packaged Core 0.3.12-rc2.1 protocol so bundled validators include its additive upstream-reference metadata.
...
- Typecheck, package build and all 33 existing tests passed.
