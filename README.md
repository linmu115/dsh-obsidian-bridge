...
[下载 CLI 权限增强版](https://github.com/linmu115/dsh-obsidian-bridge/releases/tag/v0.4.1-rc2.10) · [安装说明](docs/INSTALL-CLI.md) · [命令与回执](docs/cli-operations.md)
...
从 [Release v0.4.1-rc2.10](https://github.com/linmu115/dsh-obsidian-bridge/releases/tag/v0.4.1-rc2.10) 下载 `dsh-obsidian-bridge-0.4.1-rc2.10.tgz`，然后：
