...
import { consumeObsidianReferenceCapture } from "../src/reference/client/annotation-consumer.ts";
import { BridgeHttpError } from "../src/reference/bridge/http-client.ts";
import {
  documentHash,
  selectedTextHash,
  type ObsidianReferenceCaptureV2,
  type ReferenceClaimV2,
} from "../src/reference/protocol.ts";
